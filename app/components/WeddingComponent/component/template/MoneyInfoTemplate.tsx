...
const MoneyInfoContainer = ({baseInfo, me, father, mother, kakaoStatus}: MoneyInfoContainerProps) => {
    ...
    return (
        ...
        >
            ...
            {toggle && (
                <>
                    {me.toggle && <MoneyCell moneyInfo={me} kakaoStatus={kakaoStatus} />}
                    {father.toggle && <MoneyCell moneyInfo={father} kakaoStatus={kakaoStatus} />}
                    {mother.toggle && <MoneyCell moneyInfo={mother} kakaoStatus={kakaoStatus} />}
                </>
            )}
        </View>
    );
