        ...
        >
            ...
            >
                    ...
                    {weddingPlace.placeTransportation.length > 0 && weddingPlace.placeTransportation[0].length > 0 && (
                        ...
                        >
                            ...
                            <Text
                                ...
                                `}
                            >
                                {weddingPlace.placeTransportation[0]}
                            </Text>
                        </View>
                    )}
                    {weddingPlace.placeTransportation.length > 1 && weddingPlace.placeTransportation[1].length > 0 && (
                        ...
                        >
                            ...
                            <Text
                                ...
                                `}
                            >
                                {weddingPlace.placeTransportation[1]}
                            </Text>
                        </View>
                    )}
                    {weddingPlace.placeTransportation.length > 2 && weddingPlace.placeTransportation[2].length > 0 && (
                        ...
                        >
                            ...
                            <Text
                                ...
                                `}
                            >
                                {weddingPlace.placeTransportation[2]}
                            </Text>
                        </View>
                    )}
                    {weddingPlace.placeTransportation.length > 3 &&
                        weddingPlace.placeTransportation.slice(3).map((transportation, index) => (
                            <Text
                                key={index}
                                size={16}
                                weight={300}
                ...
                {weddingPlace.placeNav && (
                    <Button
                        text={"길 찾기"}
                        onClick={() => window.open(weddingPlace.placeUrl)}
                        ui={css`
                            align-self: stretch;
                            margin: 0 24px;
                        `}
