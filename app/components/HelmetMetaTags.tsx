...
const HelmetMetaTags = () => {
    return (
        ...
        >
            ...
            <meta
                name="description"
                content="모바일 청첩장 링크메리와 함께 결혼을 더욱 특별하게. 이제, 종이 청첩장 대신 스마트폰으로 간편하고 빠르게 초대장을 보내보세요. 모바일 청첩장 제작까지 단 5분 모바일 초대장 링크메리 모바일 청첩장, 모바일 초대장은 링크메리"
            />
            <meta
                name="keywords"
                content="모바일청첩장,모바일 초대장,셀프청첩장,무료모바일청첩장,결혼식 초대장,청첩장,결혼준비,디지털 청첩장,카카오톡 청첩장,모바일 청첩장 템플릿"
            />
