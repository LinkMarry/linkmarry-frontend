...
const StopArrowDown = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="current" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path
                d="M19.7071 10.8107C20.0976 10.4202 20.0976 9.78699 19.7071 9.39646C19.3166 9.00594 18.6834 9.00594 18.2929 9.39646L12.8839 14.8055L12.8839 3.00002C12.8839 2.50002 12.5 2.00002 12 2.00002C11.4788 2.00001 11.1161 2.50002 11.1161 3.00002L11.1161 14.8055L5.70711 9.39646C5.31658 9.00594 4.68342 9.00594 4.29289 9.39646C3.90237 9.78699 3.90237 10.4202 4.29289 10.8107L11.1161 17.6339C11.6043 18.1221 12.3957 18.1221 12.8839 17.6339L19.7071 10.8107Z"
                fill="current"
            />
            <path
                fillRule="evenodd"
