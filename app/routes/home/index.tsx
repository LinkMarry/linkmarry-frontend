...
const Home = () => {
    ...
    return (
        <MainWrapper>
            <View>
                <Section1 onViewSample={handleViewSample} onCreateWedding={handleCreateWedding} />
                <Section2 />
                <Section3 />
...
const reviewData: Review[] = [
    {
        content:
            "다른 모바일 청첩장과는 달리 레트로나 빈티지 같은 독특한 스타일로 청첩장을 만들 수 있어서 좋네요. 아내가 아주 좋아합니다!",
        username: "gn****",
        createdAt: "2025.9.2",
    },
    {
        content:
            "완전 똥손인데도 쉽고 빠르게 만들수있어서 좋아요. 특히 하객들 참석 및 식사유무 데이터화 할수있어서 편해요ㅎㅎ",
        username: "ster****",
        createdAt: "2025.10.9",
    },
    {
            ...
            >
                ...
                >
                    ...
                    <Button
                        ...
                        leadingIcon={<img src="/naver.svg" alt="" />}
                        ui={css`
