...
export const WeddingPosterEditorNavigationBarTypeList = [
    'design',
    'image',
    'baseInfo'
] as const;
...
export const weddingInvitationEditorNavigationBarTypeRecord: Record<WeddingInvitationEditorNavigationBarType, NavigationBarTypeRecordValue> = {
    design: {
        icon: 'Brush',
...
export const weddingPosterEditorNavigationBarTypeRecord: Record<WeddingPosterEditorNavigationBarType, NavigationBarTypeRecordValue> = {
    design: {
        navigationBarText: '디자인',
        inspectorTitleText: '디자인',
        icon: 'Brush',
