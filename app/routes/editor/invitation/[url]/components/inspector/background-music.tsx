...
const WeddingInvitationEditorBackgroundMusicInspector = ({
    ...
    const [selectedPlayingMusicUrl, setSelectedPlayingMusicUrl] = useState<string | undefined>(
    ...
    return (
        ...
        >
            ...
            >
                {backgroundMusics ? (
                    backgroundMusics.map((music, index) => (
                        <Item
                            key={index}
                            music={music}
            ...
            {backgroundMusics &&
                (backgroundMusic.backgroundMusicUrl === "" ||
                backgroundMusics.map(i => i.musicUrl).includes(backgroundMusic.backgroundMusicUrl) ? (
                    <View
                        as={"label"}
                        htmlFor={inputId}
                        ui={css`
                    ...
                    >
                        ...
                        >
                            <Text
                                ...
                                `}
                            >
                                {backgroundMusic.backgroundMusicName}
                            </Text>
                            <Spacer />
                        </View>
                        <View
            ...
            <FormToggle
                checked={backgroundMusic.effect}
                OnChange={checked =>
                    update(draft => {
            ...
            <Text
                ...
                `}
            >
                브라우저 정책에 따라 자동 재생 기능이 작동하지 않을 수 있습니다.
            </Text>
        </EditorInspectorWrapper>
    );
};
...
export default WeddingInvitationEditorBackgroundMusicInspector;
