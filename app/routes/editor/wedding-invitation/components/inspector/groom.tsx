        ...
        <EditorInspectorWrapper type={"groom"}>
            ...
            >
                ...
                >
                    ...
                    >
                        <Input
                            placeholder={"영문 이름"}
                            value={baseInfo.groomEnglishName}
                            onChange={event =>
                                update(draft => {
            ...
            >
                ...
                >
                    <Input
                        placeholder={"성"}
                        value={baseInfo.groomFatherFirstName}
                        onChange={event =>
                            update(draft => {
                    ...
                    <Input
                        placeholder={"이름"}
                        value={baseInfo.groomFatherLastName}
                        onChange={event =>
                            update(draft => {
                    ...
                    <Input
                        placeholder={"관계"}
                        value={baseInfo.groomFatherFamilyName}
                        onChange={event =>
                            update(draft => {
            ...
            >
                ...
                >
                    <Input
                        placeholder={"성"}
                        value={baseInfo.groomMotherFirstName}
                        onChange={event =>
                            update(draft => {
                    ...
                    <Input
                        placeholder={"이름"}
                        value={baseInfo.groomMotherLastName}
                        onChange={event =>
                            update(draft => {
                    ...
                    <Input
                        placeholder={"관계"}
                        value={baseInfo.groomMotherFamilyName}
                        onChange={event =>
                            update(draft => {
