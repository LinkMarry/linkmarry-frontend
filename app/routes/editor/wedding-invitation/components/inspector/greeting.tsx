import {Text, Input, Textarea, Select, SegmentedButton, View} from "~/components";
        ...
        <EditorInspectorWrapper type={"greeting"}>
            {value.greeting.greetingDesign === "TEXT" && (
                ...
                >
                    ...
                    <Input
                        hasLabel={false}
                        value={value.greeting.greetingTitle}
                        onChange={event =>
                            update(draft => {
            ...
            >
                ...
                <Textarea
                    hasLabel={false}
                    value={value.greeting.greetingContent}
                    onChange={event =>
                        update(draft => {
