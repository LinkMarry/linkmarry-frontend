...
const EditorInspectorMoney = ({value: {moneyInfo}, update}: Binding<Wedding>) => {
    ...
    return (
        <EditorInspectorWrapper type={"money"}>
            ...
            >
                <Checkbox
                    checked={moneyInfo.groomFatherToggle}
                    OnChange={checked =>
                        update(draft => {
            ...
            >
                <Checkbox
                    checked={moneyInfo.groomMotherToggle}
                    OnChange={checked =>
                        update(draft => {
            ...
            >
                <Checkbox
                    checked={moneyInfo.brideFatherToggle}
                    OnChange={checked =>
                        update(draft => {
            ...
            >
                <Checkbox
                    checked={moneyInfo.brideMotherToggle}
                    OnChange={checked =>
                        update(draft => {
