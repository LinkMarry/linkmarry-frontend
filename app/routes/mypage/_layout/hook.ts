...
import {type MyPageIndexSidebarType} from "~/routes/mypage/_layout/components/MyPageIndexSidebarType.ts";
import {myPageIndexSidebarTypeList} from "~/routes/mypage/_layout/components/MyPageIndexSidebarType.ts";
