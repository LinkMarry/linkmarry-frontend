...
import useMyPageWedding from "./hook.ts";
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <View
                                flexDirection={"row"}
                                onClick={() => window.open(weddingUrl)}
                                ui={css`
                                    gap: 4px;
                                    align-items: center;
                                    cursor: pointer;
                        ...
                        >
                            {statistics ? (
                                <>
                                    ...
                                    <StatisticsCell
                                        title={"링크 클릭 횟수"}
                                        value={`${statistics.totalVisitorCnt}회`}
                                    />
                                </>
                            ) : (
                                <Loading />
