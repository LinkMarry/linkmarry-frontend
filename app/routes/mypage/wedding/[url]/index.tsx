...
import useMyPageStat from "./hook.ts";
        ...
        >
            ...
            >
                ...
                >
                    ...
                    {statistics ? <Stats statistics={statistics} /> : <Loading />}
                </View>
                <View
                    ui={css`
                        gap: 8px;
                                        ...
                                        rsvpInfoList.map(rsvp => (
                                            ...
                                            >
                                                ...
                                                <td
                                                    ...
                                                    `}
                                                >
                                                    {wedding?.rsvp.attendGuestCntStatus ? rsvp.guestCnt : "-"}
                                                </td>
                                                <td
                                                    className={css`
                                                        ${CellStyle};
                                                ...
                                                <td
                                                    ...
                                                    `}
                                                >
                                                    {wedding?.rsvp.attendEtcStatus ? rsvp.guestComment : "-"}
                                                </td>
                                            </tr>
                                        ))
                                    ) : (
...
const MobileStatCell = ({title, value}: StatCellProps) => {
    return (
        <View flexDirection={"row"} ui={cx(mobileStyle)}>
            <Text
                type={"p3"}
                ui={css`
                    color: var(--g-500);
